...
TYPES = {
    "NUMBER_OPERATION": [
        ...
        ("05", "특수 합·곱", ["gauss", "연속 자연수 합", "oddsum", "홀수의 합", "제곱수", "maxprod", "곱 최대", "sumprod", "합과 곱"]),
    ...
    "CHANGE_RELATION": [
        ("01", "규칙·수열 찾기", ["규칙 찾기", "일정하게", "seq", "계차", "pattern", "반복 규칙", "cycle", "반복 주기", "geoseq", "등비 규칙", "fib", "피보나치", "squarenum", "사각수", "trinum", "삼각수", "numline"]),
        ...
        ("06", "일·전략·나이", ["work", "일의 양", "tank", "일률", "age", "나이", "sumdiff", "합과 차", "transfer", "주고받기", "josephus", "nim", "필승", "배수 남기기", "diophantine", "부정방정식", "trans", "이행성", "순서 추론"]),
    ],
    "SHAPE_MEASUREMENT": [
        ...
        ("07", "대칭·거울", ["대칭", "foldcut", "symaxis", "mirror", "거울", "gridtiny", "grideasy", "gridrect"]),
    ],
    "DATA_POSSIBILITY": [
        ("01", "경우의 수·곱의 원리", ["곱의 원리", "outfit", "cases", "coinflip", "passcode", "twodigit", "electpair", "coincomb", "diceprod", "dicesum", "gift"]),
        ("02", "순서 세기·순열", ["순서", "순열", "lineup", "perm", "circperm", "원순열", "necklace", "염주", "multiperm", "위치", "position", "htorder"]),
        ...
        ("05", "확률", ["확률", "simpleprob", "atleastprob", "여사건", "derange", "교란"]),
        ("06", "논리·전략·불변량", ["truthone", "진실", "pigeon", "비둘기집", "parity", "불변량", "balance", "저울", "knockout", "tourney", "토너먼트", "hanoi", "하노이", "collatz", "lights", "catalan", "setboth", "포함배제"]),
    ],
}
