...
object Monetization {
    ...
    /**
     * 출시 기념 전면 무료 마감 시각(epoch millis) = **KST 2026-11-01 00:00으로 확정**
     * (2026-10-31 자정까지 무료 — 오너 결정 2026-07-17). 이 시각 이전에는 모든 콘텐츠·리포트가
     * 이용권 없이 무료다. 0으로 두면 프로모션 없음(원래 무료/유료 경계).
     */
